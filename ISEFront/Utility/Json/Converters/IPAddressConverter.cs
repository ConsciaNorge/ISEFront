...
// From https://pingfu.net/csharp/2015/07/16/how-to-serialise-ipaddress-ipendpoint.html

namespace ISEFront.Utility.Json.Converters
{
    public class IPAddressConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return IPAddress.Parse(token.ToString());
            }
            ...
            {
                return token.Select(address => IPAddress.Parse((string)address)).ToList();
            }
