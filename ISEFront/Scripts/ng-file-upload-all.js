        ...
        FileAPI.ngfFixIE = function (elem, fileElem, changeFn) {
            ...
            var fixInputStyle = function () {
                ...
                if (elem.attr('disabled')) {
                    if (label)
                        label.removeClass('js-fileapi-wrapper');
                }
                else {
...
ngFileUpload.service('Upload', ['$parse', '$timeout', '$compile', '$q', 'UploadExif', function ($parse, $timeout, $compile, $q, UploadExif) {
        ...
        upload.updateModel = function (ngModel, attr, scope, fileChange, files, evt, noDelay) {
            ...
            var allNewFiles, dupFiles = [], prevValidFiles, prevInvalidFiles, invalids = [], valids = [];
...
ngFileUpload.service('UploadResize', ['UploadValidate', '$q', function (UploadValidate, $q) {
        ...
        upload.resize = function (file, options) {
            ...
            upload.dataUrl(file, true).then(function (url) {
                resize(url, options.width, options.height, options.quality, options.type || file.type, options.ratio, options.centerCrop, options.resizeIf)
...
//# sourceMappingURL=ng-file-upload-all.js.map