...
(function (s, f) {
    'use strict';
    function J(f) { var k = []; v(k, B).chars(f); return k.join(""); }
    ...
    f.module("ngSanitize", []).provider("$sanitize", function () {
        function h(a, c) { var b = {}, d = a.split(","), l; for (l = 0; l < d.length; l++)
            b[c ? q(d[l]) : d[l]] = !0; return b; }
        function K(a) { for (var c = {}, b = 0, d = a.length; b < d; b++) {
            var l = a[b];
            c[l.name] = l.value;
        } return c; }
        function H(a) {
        ...
        function t(a, c) { var b = c[a]; if (b && F.call(c, b))
            throw w("elclob", c.outerHTML || c.outerText); return b; }
        var x = !1;
        this.$get =
            ["$$sanitizeUri", function (a) { x && k(p, z); return function (c) { var b = []; G(c, v(b, function (b, c) { return !/^unsafe:/.test(a(b, c)); })); return b.join(""); }; }];
        this.enableSvg = function (a) { return E(a) ? (x = a, this) : x; };
        C = f.bind;
        k = f.extend;
        D = f.forEach;
        E = f.isDefined;
